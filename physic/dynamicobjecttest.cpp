...
void DynamicObjectTest::getVelocityX_velocityInXSetTo12_12()
{
	PhysicSimulator simulator;
	DynamicObject object(simulator, Point(), 0, 0);

	object.applyLinearVelocity(12, 5);

	CPPUNIT_ASSERT_DOUBLES_EQUAL(12, object.getVelocityX(), 0.0001);
}

void DynamicObjectTest::getVelocityY_velocityInYSetTo5_5()
{
	PhysicSimulator simulator;
	DynamicObject object(simulator, Point(), 0, 0);
	...
	CPPUNIT_ASSERT_DOUBLES_EQUAL(5, object.getVelocityY(), 0.0001);
}
