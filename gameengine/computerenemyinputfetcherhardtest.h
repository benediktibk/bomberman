...
namespace GameEngine
{
			...
			public CPPUNIT_NS::TestFixture
	{
		...
		CPPUNIT_TEST(getInputState_besideSaveFieldAsPossibleTargetToBlowUpWallButToSlowToEscape_noMovementButtonPressed);
	...
	public:
		...
		void getInputState_besideSaveFieldAsPossibleTargetToBlowUpWallButToSlowToEscape_noMovementButtonPressed();
